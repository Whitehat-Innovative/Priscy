          ...
          <div class="col-lg-12">
            ...
            <div class="search-fields-container">
              <div class="contact-form-action">
                <form action="{{ route('admin.add_ticket') }}" method="POST" class="row">@csrf
                    ...
                    <div class="input-box">
                      ...
                      <div class="form-group">
                        ...
                        <input
                          ...
                          type="text"
                          name="from"
                          placeholder="Deaprture Terminal"
                        />
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-3 pr-0">
                    <div class="input-box">
                      <label class="label-text">Travelling To</label>
                      <div class="form-group">
                        <span class="la la-map-marker form-icon"></span>
                        <input
                          class="form-control"
                      ...
                      <div class="input-box">
                        ...
                        <div class="form-group">
                            <input
                              ...
                              type="number"
                              name="seats" placeholder="Enter No. of seats"
                            />
                          </div>
                      </div>
                    </div>
                ...
                <div class="btn-box pt-2">
                  <a href="{{ route('checkout') }}" class="theme-btn"
                    >Proceed</a
                  >
                </div>
              </div>
