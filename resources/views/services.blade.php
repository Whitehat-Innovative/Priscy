                        ...
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title text-white">
                                    The easiest way to make a bus ticket reservation
                                </h2>
                            </div>
                        </div>
            ...
            <div class="row padding-top-80px">
                ...
                <div class="col-lg-3 responsive-column">
                    <div class="icon-box icon-layout-4">
                        ...
                        <div class="info-content">
                            <h4 class="info__title"><a href="#">Best trip price</a></h4>
                            <p class="info__desc">
                                Bringing you more routes at the best fares.
                            </p>
                        </div>
                        <!-- end info-content -->
                    </div>
                ...
                <div class="col-lg-3 responsive-column">
                    <div class="icon-box icon-layout-4">
                        ...
                        <!-- end info-icon-->
                        <div class="info-content">
                            <h4 class="info__title"><a href="#">Security</a></h4>
                            <p class="info__desc">
                                When it comes to exchange of money for value, security matters.
                            </p>
                        </div>
                        <!-- end info-content -->
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="tab-content-info mt-n4 d-flex justify-content-between align-items-center">
                        ...
                        <a href="#" class="btn-text font-size-15">Contact us <i
