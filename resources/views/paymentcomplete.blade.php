                            ...
                            <div class="payment-received-list">
                                ...
                                <ul class="list-items list-items-3 list-items-4 py-4">
                                    <li><span class="text-black font-weight-bold">Your
                                            reservation</span>{{ $ticket->seats }} Seats</li>
                                    <li><span
                                            class="text-black font-weight-bold">Departure</span>{{ \Carbon\Carbon::parse($ticket->date_time)->format('d M Y, h:ia') }}
                                    </li>
                                    <li><span
                                            class="text-black font-weight-bold">Total</span>₦{{ number_format($ticket->amount) }}
                                    </li>
                                    <li><span class="text-black font-weight-bold">Seat Nos.</span>
                                        <strong>
