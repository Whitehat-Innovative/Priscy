                        ...
                        <div class="mb-6 flex items-center justify-between">
                            <div
                                ...
                                <img class="block h-8 w-8 rounded-full border-2 border-white/50 object-cover ltr:mr-1 rtl:ml-1"
                                    src="/travelassets/images/profile-34.jpeg" alt="image" />
                                Alan Green
                            </div>
                            <button type="button"
                        ...
                        <div class="rounded-md bg-white px-4 py-2.5 shadow dark:bg-[#060818]">
                            <span class="mb-4 flex items-center justify-between dark:text-white">Received
                                <svg class="h-4 w-4 text-success" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M19 15L12 9L5 15" stroke="currentColor"
                                        stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </svg>
                            </span>
                            ...
                            <tbody>
                                    ...
                                    <td class="min-w-[150px] text-black dark:text-white">
                                        <div class="flex items-center">
                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                src="/travelassets/images/profile-6.jpeg" alt="avatar" />
                                ...
                                <tr
                                    ...
                                    <td class="text-black dark:text-white">
                                        <div class="flex items-center">
                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                src="/travelassets/images/profile-7.jpeg" alt="avatar" />
                                ...
                                <tr
                                    ...
                                    <td class="text-black dark:text-white">
                                        <div class="flex items-center">
                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                src="/travelassets/images/profile-8.jpeg" alt="avatar" />
                                ...
                                <tr
                                    ...
                                    <td class="text-black dark:text-white">
                                        <div class="flex items-center">
                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                src="/travelassets/images/profile-9.jpeg" alt="avatar" />
                                ...
                                <tr
                                    ...
                                    <td class="text-black dark:text-white">
                                        <div class="flex items-center">
                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                src="/travelassets/images/profile-10.jpeg" alt="avatar" />
                            ...
                            <tbody>
                                <tr
                                    ...
                                    <td class="min-w-[150px] text-black dark:text-white">
                                        <div class="flex">
                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                src="/travelassets/images/product-headphones.jpg"
                                                alt="avatar" />
                                ...
                                <tr
                                    ...
                                    <td class="text-black dark:text-white">
                                        <div class="flex">
                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                src="/travelassets/images/product-shoes.jpg" alt="avatar" />
                                ...
                                <tr
                                    ...
                                    <td class="text-black dark:text-white">
                                        <div class="flex">
                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                src="/travelassets/images/product-watch.jpg" alt="avatar" />
                                ...
                                <tr
                                    ...
                                    <td class="text-black dark:text-white">
                                        <div class="flex">
                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                src="/travelassets/images/product-laptop.jpg" alt="avatar" />
                                ...
                                <tr
                                    ...
                                    <td class="text-black dark:text-white">
                                        <div class="flex">
                                            <img class="h-8 w-8 rounded-md object-cover ltr:mr-3 rtl:ml-3"
                                                src="/travelassets/images/product-camera.jpg" alt="avatar" />
