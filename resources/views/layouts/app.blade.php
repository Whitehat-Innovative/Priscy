...
<!-- Mirrored from html.vristo.sbthemes.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Sep 2023 13:14:00 GMT -->
<!-- Added by HTTrack -->
...
<body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased"
                ...
                <div class="h-full bg-white dark:bg-[#0e1726]">
                    <div class="flex items-center justify-between px-4 py-3">
                        <a href="index-2.html" class="main-logo flex shrink-0 items-center">
                            <img class="ml-[5px] w-8 flex-none" src="/travelassets/images/logo.svg" alt="image" />
                            <span
                    ...
                    <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold"
                        ...
                        <li class="menu nav-item">
                            ...
                            <ul class="sub-menu text-gray-500">
                                <li>
                                    <a href="{{ route('admin.routeview') }}" class="active">Add Route</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.ticketview') }}">Tickets</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.view') }}">View Tickets</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.route') }}">View Route</a>
                                </li> 
                            </ul>
                        </li>
                    </ul>
                ...
                <div class="shadow-sm">
                    <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
                        <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                            <a href="index-2.html" class="main-logo flex shrink-0 items-center">
                                <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="/travelassets/images/logo.svg"
                                    alt="image" />
                                <span
                            ...
                            <div class="dropdown flex-shrink-0" x-data="dropdown"
                                ...
                                <a href="javascript:;" class="group relative" @click="toggle()">
                                    <span><img
                                            ...
                                            src="/travelassets/images/user-profile.jpeg" alt="image" /></span>
                                </a>
                                <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                                        ...
                                        <div class="flex items-center px-4 py-4">
                                            <div class="flex-none">
                                                <img class="h-10 w-10 rounded-md object-cover"
                                                    src="/travelassets/images/user-profile.jpeg" alt="image" />
                                            </div>
                    ...
                    <ul
                        ...
                        <li class="menu nav-item relative">
                            ...
                            <ul class="sub-menu">
                                <li>
                                    <a href="{{ route('admin.routeview') }}" class="active">Route</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.ticketview') }}">Tickets</a>
                                </li>
    ...
    <script defer src="/travelassets/js/apexcharts.js"></script>
