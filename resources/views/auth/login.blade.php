...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;500;600;700;800&amp;display=swap"
        rel="stylesheet" />
    <link rel="stylesheet" type="text/css" media="screen" href="/travelassets/css/perfect-scrollbar.min.css" />
    <link rel="stylesheet" type="text/css" media="screen" href="/travelassets/css/style.css" />
    <link defer rel="stylesheet" type="text/css" media="screen" href="/travelassets/css/animate.css" />
    <script src="/travelassets/js/perfect-scrollbar.min.js"></script>
    <script defer src="/travelassets/js/popper.min.js"></script>
    <script defer src="/travelassets/js/tippy-bundle.umd.min.js"></script>
    <script defer src="/travelassets/js/sweetalert.min.js"></script>
</head>
...
<body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased"
    ...
    <div class="main-container min-h-screen text-black dark:text-white-dark">
        ...
        <div x-data="auth">
            <div class="absolute inset-0">
                <img src="/travelassets/images/auth/bg-gradient.png" alt="image"
            ...
            <div
                ...
                <img src="/travelassets/images/auth/coming-soon-object1.png" alt="image"
                    class="absolute left-0 top-1/2 h-full max-h-[893px] -translate-y-1/2" />
                <img src="/travelassets/images/auth/coming-soon-object2.png" alt="image"
                    class="absolute left-24 top-0 h-40 md:left-[30%]" />
                <img src="/travelassets/images/auth/coming-soon-object3.png" alt="image"
                    class="absolute right-0 top-0 h-[300px]" />
                <img src="/travelassets/images/auth/polygon-object.svg" alt="image"
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                            <a href="index-2.html" class="block w-48 lg:w-72 ms-10">
                                <img src="/travelassets/images/auth/logo-white.svg" alt="Logo" class="w-full" />
                            </a>
                            <div class="mt-24 hidden w-full max-w-[430px] lg:block">
                                <img src="/travelassets/images/auth/login.svg" alt="Cover Image" class="w-full" />
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <div
                            ...
                            <a href="index-2.html" class="block w-8 lg:hidden">
                                <img src="/travelassets/images/logo.svg" alt="Logo" class="w-full" />
                            </a>
                            <div class="dropdown ms-auto w-max" x-data="dropdown"
                                ...
                                <a href="javascript:;"
                                    ...
                                    <div>
                                        <img :src="`/travelassets/images/flags/${$store.app.locale.toUpperCase()}.svg`"
                                        ...
                                        <li>
                                            <a href="javascript:;" class="hover:text-primary"
                                                ...
                                                <img class="h-5 w-5 rounded-full object-cover"
                                                    :src="`/travelassets/images/flags/${item.value.toUpperCase()}.svg`"
                                                    alt="image" />
                        ...
                        <div class="w-full max-w-[440px] lg:mt-16">
                            ...
                            <div class="text-center dark:text-white">
                                ...
                                <a href="auth-cover-register.html"
    ...
    <script src="/travelassets/js/alpine-collaspe.min.js"></script>
    <script src="/travelassets/js/alpine-persist.min.js"></script>
    <script defer src="/travelassets/js/alpine-ui.min.js"></script>
    <script defer src="/travelassets/js/alpine-focus.min.js"></script>
    <script defer src="/travelassets/js/alpine.min.js"></script>

    <script src="/travelassets/js/custom.js"></script>
...
<!-- Mirrored from html.vristo.sbthemes.com/auth-cover-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Sep 2023 13:14:46 GMT -->
